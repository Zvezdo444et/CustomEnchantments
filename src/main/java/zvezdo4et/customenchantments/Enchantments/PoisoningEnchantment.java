...
public class PoisoningEnchantment extends ProcreatorEnchantments {
    public static final PoisoningEnchantment INSTANCE = new PoisoningEnchantment();

    public PoisoningEnchantment() {
        super(
                new NamespacedKey(CustomEnchantments.getInstance(), "poisoning"),
                "Отравление",
                2,
                10,
                10,
    ...
    public @NotNull Component displayName(int level) {
        return Component.text("Отравление " + toRoman(level))
